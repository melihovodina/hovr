...
export function Faq() {
  return (
    <section id="faq" className="scroll-mt-28 px-4 pb-24 sm:px-8 lg:px-16 lg:pb-[140px]">
  ...
  return (
    <section className="px-4 sm:px-8 lg:px-16">
      <div className="mx-auto flex max-w-[1312px] flex-col items-center gap-6 rounded-[36px] bg-lime px-6 py-16 text-center text-on-lime sm:px-16 lg:py-24">
        ...
        <span className="text-sm font-semibold text-[rgba(13,14,17,0.7)]">Free plan, no card needed.</span>
      </div>
    </section>
  );
}
