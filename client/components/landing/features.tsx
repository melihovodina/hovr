...
export function Features() {
  return (
    <section id="features" className="scroll-mt-28 px-4 pb-16 sm:px-8 md:pb-24 lg:px-16 lg:pb-35">
      <div className="mx-auto flex max-w-328 flex-col gap-7 lg:gap-12">
        <h2 className="max-w-190 text-[36px] leading-[1.06] font-extrabold tracking-[-0.04em] sm:text-[44px] lg:text-[52px]">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className={`${card} bg-lime text-on-lime`}>
            <div className="flex flex-col gap-2">
              ...
              <span className="self-end rounded-[18px_18px_6px_18px] bg-on-lime px-3.25 py-2.25 text-sm text-[#F3F2EE]">
                is the espresso blend ok for filter?
              </span>
              <span className="self-start rounded-[18px_18px_18px_6px] bg-[rgba(13,14,17,0.08)] px-3.25 py-2.25 text-sm leading-[1.45]">
          ...
          <div className={`${card} bg-[#111215] text-[#F3F2EE] md:col-span-2`}>
            <div className="flex flex-col gap-3 rounded-[18px] border border-[#2A2D34] bg-[#1A1C21] p-4.5">
              {TOP.map((t) => (
